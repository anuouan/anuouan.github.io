  ...
  <div id="login_div">
    <form action="LoginCheckServlet" method="post">
      <table id="login_table" cellpadding="0">
        ...
        <tr height="40">
          <%-- 如果登录失败，回到登录页面时，显示提示信息 --%>
          <td align="center">${tips}</td>
        </tr>
        <tr>
          <td align="center"><input type="text" name="userName" placeholder="管理员账号" class="inputStyle"/></td>
        </tr>
        <tr>
          <td align="center"><input type="password" name="userPwd" placeholder="管理员密码" class="inputStyle"/></td>
        </tr>
        <tr>
          <td align="center">
